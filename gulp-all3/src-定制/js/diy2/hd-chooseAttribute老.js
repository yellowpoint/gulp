	...
	function attributePopup() {
		...
		$('.attributePopup .ap-main .attrItemBox .attrItem').off().click(function() {
			...
			if($(this).hasClass('act')) {
				...
				choosableBox = attributeList;
				selectedList2 = $('.attributePopup .ap-main .attrItemBox .attrItem.act');
				$('.attributePopup .ap-main .attrItemBox .attrItem').removeClass('act')
				$.each(selectedList2, function(j) {
					console.log(j)
					selectedList2[j].click();
				})
